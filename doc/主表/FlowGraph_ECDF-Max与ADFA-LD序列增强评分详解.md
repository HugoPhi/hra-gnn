...
| HRA-GNN + unigram + Markov（SSL 权重 0.20） | **0.8650** | **0.8526** |
...
| 模型 | AUROC | AP |
|---|---:|---:|
| HRA-GNN 序列增强评分（SSL 权重 0.20） | **0.8650** | **0.8526** |
| HRGCN | 0.8331 | 0.7789 |
| HGT | 0.8253 | 0.7679 |
...
> 在固定 ADFA-LD-1000 协议下，完整评分获得 0.8650 AUROC 和 0.8526 AP；
> 移除任一序列分量都会降低 AP。
...
HRA-GNN 原模型无需任何调参就在 ADFA-LD 上达到 0.8526 AP。
