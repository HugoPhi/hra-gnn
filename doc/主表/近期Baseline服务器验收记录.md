...
![TraceLog 直接任务基线诊断表](../assets/tables/direct_baselines_diagnostic.svg)
...
![TraceLog 与 FlowGraph 直接基线双数据集诊断表](../assets/tables/direct_baselines_two_datasets.svg)
...
![四数据集直接基线诊断表](../assets/tables/four_dataset_diagnostic.svg)
