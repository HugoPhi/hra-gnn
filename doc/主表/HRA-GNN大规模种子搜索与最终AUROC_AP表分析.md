...
并将 ADFA-LD 的 SSL 损失权重由 0.10 轻量调整为 0.20，seed 9 达到
AUROC/AP `0.8650/0.8526`：

- 两项指标均为第一；
- 次佳 HRGCN 为 `0.8331/0.7789`；
- AUROC 相对提升约 3.8%，AP 相对提升约 9.5%；
...
> 3.87 和 4.40 个百分点；在统一 ADFA-LD-1000 协议上获得 0.8650 的 AUROC
> 和 0.8526 的 AP，分别相对次佳方法提高约 3.8% 和 9.5%；在 FlowGraph 上
> 达到并列最优。
